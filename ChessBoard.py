...
class ChessBoard:
	...
	# to save the pizel values of empty board
	blankBoardMatrix = []
	...
	def createTopology(self):
		...
		# for i in range(0,8):
		# 	for j in range(0,8):
		# 		print self.blankBoardMatrix[i][j];

		# return;
		
		# plt.imshow(self.blankBoardMatrix[0][6]),plt.show()
		# plt.imshow(self.fullBoardMatrix[0][6]),plt.show()
